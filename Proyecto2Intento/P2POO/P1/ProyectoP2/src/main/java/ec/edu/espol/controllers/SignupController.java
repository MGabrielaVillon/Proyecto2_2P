...
public class SignupController implements Initializable {
    ...
    private void registrar(MouseEvent event) {
        if (!casillasVacias()) {
            ...
            if (Usuario.validarCorreo(usuarios, corr)) {
                ...
                Usuario.guardarArchivoUsuarios(u, "Usuarios.XML");
                ingresar(event);
            }
        }
    }
    ...
    @FXML
    private void ingresar(MouseEvent event) { //CODIGO REPETIDO
        try {
    ...
    private boolean casillasVacias(){
        return (nombre.getText().equals("") || apellido.getText().equals("") || correo.getText().equals("") || contraseña.getText().equals(""));
    }
