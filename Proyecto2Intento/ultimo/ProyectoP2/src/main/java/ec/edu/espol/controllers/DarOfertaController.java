...
//        }
    ...
    private void guardar(MouseEvent event) {
        ...
        if(valor.getText().equals("") || correo.getText().equals("")){
            Alert a = new Alert(Alert.AlertType.INFORMATION, "Necesita registrar todos los datos");
            a.show();
        } else {
           Vehiculo x =Vehiculo.obtenerVehiculo(vehiculos, placa.getText());
           
          try(BufferedWriter bf= new BufferedWriter(new FileWriter("Ofertas.txt",true))){
          StringBuilder sb= new StringBuilder();
          sb.append( x.getTipo()+" - "+placa.getText()+" - "+correo.getText()+" - "+valor.getText());
